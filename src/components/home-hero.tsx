    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-24 pb-32 text-center overflow-hidden">
      ...
      >
        ...
        >
          <Link
            to="/katalyst-growth"
            className="group relative inline-flex items-center justify-center bg-white text-black px-10 py-5 text-lg font-medium transition-all duration-700 hover:scale-[1.02] active:scale-[0.98] shadow-2xl shadow-black/20 overflow-hidden"
          ...
          >
            ...
            <div className="absolute inset-0 bg-gray-50 opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
          </Link>
          <Link
            to="/katalyst-automation"
            className="group inline-flex items-center justify-center text-white px-10 py-5 text-lg font-medium transition-all duration-700"
            style={{background: 'var(--icon-bg)', border: '1px solid var(--card-border)', borderRadius: '980px'}}
          >
            Katalyst Automation
            <ArrowRight className="w-5 h-5 ml-2 transition-transform duration-700 group-hover:translate-x-1" />
          </Link>
