...
import { GROWTH_CARDS, GROWTH_STATS_BADGE, GROWTH_HEADLINE, GROWTH_SUBTEXT } from "@/data/growth";
          ...
          <div className="relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full" style={{background: 'var(--icon-bg)', border: '1px solid var(--card-border)'}}>
                ...
                <span className="text-sm font-medium text-white/90">{GROW_STATS_BADGE}</span>
              </div>
            </motion.div>
