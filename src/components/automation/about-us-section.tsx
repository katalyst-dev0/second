...
const services = [
  {
    ...
    description:
      "Catalog internal workflows, KPIs, and constraints so we can prioritize where AI automation unlocks real capacity.",
    position: "left",
  },
  {
    ...
    description:
      "Design service-specific AI copilots, data bridges, and hand-off rules that replace manual workstreams step-by-step.",
    position: "left",
  },
  {
    ...
    description:
      "Deploy trained AI agents, orchestrate them with integrations, and shepherd curated templates into production.",
    position: "left",
  },
  {
    icon: <Zap className="w-6 h-6" />,
    secondaryIcon: <Sparkles className="w-4 h-4 absolute -top-1 -right-1 text-red-400" />,
    title: "Productivity Guardrails",
    description:
      "Monitor process health, human hand-offs, and compliance so automation scales without eroding service quality.",
    position: "right",
  },
  {
    ...
    description:
      "Turn automation telemetry into action—faster lead follow-ups, proactive upsells, and smarter resource planning.",
    position: "right",
  },
  {
    icon: <TrendingUp className="w-6 h-6" />,
    secondaryIcon: <Star className="w-4 h-4 absolute -top-1 -right-1 text-red-400" />,
    title: "Enablement Studio",
    description:
      "Train teams, refine SOPs, and hand over living playbooks so you can expand automation without latency.",
    position: "right",
  },
]

const stats = [
  { icon: <Award className="w-6 h-6" />, value: 420, label: "Workflows Automated", suffix: "+" },
  { icon: <Users className="w-6 h-6" />, value: 2300, label: "Hours Saved Weekly", suffix: "+" },
  { icon: <Target className="w-6 h-6" />, value: 90, label: "Net Productivity Lift", suffix: "%" },
  { icon: <TrendingUp className="w-6 h-6" />, value: 75, label: "Clients Seeing Growth", suffix: "+" },
]
  ...
  return (
    ...
    >
      ...
      <motion.div className="container mx-auto max-w-6xl relative z-10" variants={containerVariants} initial="hidden" animate={isInView ? "visible" : "hidden"}>
        ...
        >
          We build AI automation systems that let small service businesses get more done with fewer people—no fluff, just measurable productivity gains.
        </motion.p>
